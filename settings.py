...
INSTALLED_APPS = ['otree', 'django_celery_beat',  'bigfive']
...
# HUEY = {'name': 'otree-huey',
#         'always_eager': False,
#         'connection':
#         {'host': 'localhost', 'password': None, 'port': 6379},
#         'consumer': {'workers': 10, 'loglevel': 'warning', 'scheduler_interval': 1},
#         'result_store': False}
